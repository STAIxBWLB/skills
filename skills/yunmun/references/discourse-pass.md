# Discourse pass — paragraph flow (long-form only)

The layer between plot and sentences: how paragraphs advance, where the energy sags, and where things sit on the page. Evidence: QUDsim/COLM 2025 (Q), Tripto et al. EMNLP 2025 (T), Russell et al. ACL 2025 (R), Beguš 2024 (B), asavvin's outline test (A). Stable source identities live in the upstream sepia research ledger (see `ATTRIBUTION.md`); single-letter aliases in this file are file-local. Prescriptions are design inferences of this skill unless a cited source explicitly tested the intervention.
